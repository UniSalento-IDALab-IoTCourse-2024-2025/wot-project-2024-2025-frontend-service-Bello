    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        ...
        <button
          ...
          disabled={isLoading}
          className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border-2 border-gray-500 dark:border-gray-500 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-50"
        >
      ...
      {isLoading && vehicles.length === 0 ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-gray-500 dark:border-gray-600">
          ...
          <Link
            to="/add-vehicle"
            className="inline-flex items-center gap-2 mt-5 px-5 py-2.5 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-xl transition-colors"
          >
